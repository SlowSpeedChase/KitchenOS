...
- [ ] **ADHD check passed** - See below
- [ ] **Scope check** - Can ship in < 1 week of focused work?
...
- [ ] **Additive, never a chore?** (self-cleans / auto-ages-out — no manual upkeep)

*If a feature fails all of these, reconsider whether it belongs in KitchenOS.*
